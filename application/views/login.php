...
<head>
  ...
  <title>Log in - Sistem Manajemen Aset</title>
...
<body>
<nav class="navbar navbar-expand navigation-clean">
  <div class="container">
    <a class="navbar-brand" href="#">LPMP Jateng</a>
    <button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"></button>
    <div id="navcol-1" class="collapse navbar-collapse">
      <a class="btn btn-primary ml-auto" role="button" href="#">Login</a>
    </div>
  </div>
</nav>
<div class="login-box">
